      ...
      <section id='next' className='p-10'>
        ...
        <div className='mt-12'>
          <p className='mt-2'>
            ...
            TypeScript, embracing the power and flexibility they offer in
          ...
          <p className='mt-2'>
            ...
            technologies, database management, and server-side development. By
            honing my skills across the entire software development stack, I
            aspire to create seamless end-to-end solutions that encompass both
          ...
          <p className='mt-2'>
            ...
            allow me to apply my expanding skill set and contribute to
